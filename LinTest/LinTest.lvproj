...
<Project Type="Project" LVVersion="18008000">
	<Item Name="我的电脑" Type="My Computer">
		...
		<Item Name="Crl" Type="Folder" URL="../Crl">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="SubVIs" Type="Folder" URL="../SubVIs">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="LinTest.vi" Type="VI" URL="../LinTest.vi"/>
		<Item Name="依赖关系" Type="Dependencies">
			...
			<Item Name="Config XML.vi" Type="VI" URL="../user VI&apos;s/XML/Config XML.vi"/>
			<Item Name="LIN Create Session Ref.vi" Type="VI" URL="../user VI&apos;s/LIN/LIN Create Session Ref.vi"/>
			<Item Name="LIN Device.ctl" Type="VI" URL="../user VI&apos;s/LIN/LIN Device.ctl"/>
			<Item Name="LIN Frame 2 Data.vi" Type="VI" URL="../user VI&apos;s/LIN/LIN Frame 2 Data.vi"/>
			<Item Name="LIN Get Key.vi" Type="VI" URL="../user VI&apos;s/LIN/LIN Get Key.vi"/>
			<Item Name="LIN LoadLDF.vi" Type="VI" URL="../user VI&apos;s/LIN/LIN LoadLDF.vi"/>
			<Item Name="LIN Read.vi" Type="VI" URL="../user VI&apos;s/LIN/LIN Read.vi"/>
			<Item Name="LIN Send Single Message.vi" Type="VI" URL="../user VI&apos;s/LIN/LIN Send Single Message.vi"/>
			<Item Name="LIN Trans Frame.vi" Type="VI" URL="../user VI&apos;s/LIN/LIN Trans Frame.vi"/>
			<Item Name="LIN Write.vi" Type="VI" URL="../user VI&apos;s/LIN/LIN Write.vi"/>
			<Item Name="Load XML.vi" Type="VI" URL="../user VI&apos;s/XML/Load XML.vi"/>
